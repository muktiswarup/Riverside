...
<!-- Mirrored from html.tonatheme.com/2023/bluebell/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jun 2026 05:39:54 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="auto-container">
            ...
            <div class="sortable-masonry">
                ...
                <div class="items-container row">
                    ...
                    <!-- Project Block -->
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-3 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                    ...
                    <!-- Project Block -->
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-4 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                    ...
                    <!-- Project Block -->
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-5 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                    ...
                    <!-- Project Block -->
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-2 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-5 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/15.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-1 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/16.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-3 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/18.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-4 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/19.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-5 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/20.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-1 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/21.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-2 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/22.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-3 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/23.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-4 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/24.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                    ...
                    <div class="gallery-block-four gallery-overlay masonry-item all cat-5 col-lg-4 col-md-6">
                        <div class="inner-box">
                            <div class="image">
                                <img src="assets/images/gallery/25.jpeg" alt="">
                            </div>
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <div class="content">
                        ...
                        <div class="widget contact-widget">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><a href="tel:18004567890">18004567890</a></td>
                                </tr>
                                <tr>
                                    <td class="lebel">Email :</td>
                                    <td><a href="mailto:info@bluebell.com">info@bluebell.com</a></td>
                                </tr>
                                <tr>
                                    <td class="lebel">Location :</td>
                                    <td>256, Resort Street, New York <br> Blue Beach, 8974</td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <div class="auto-container">
                <div class="wrapper-box">
                    <div class="copyright text-center">
                        <div class="text">© Copyright  Bluebell Resort HTML Template. All right reserved.</div>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from html.tonatheme.com/2023/bluebell/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jun 2026 05:39:57 GMT -->
</html>
